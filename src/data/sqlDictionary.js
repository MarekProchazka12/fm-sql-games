export const sqlDictionary = {
    ...
    "DISTINCT": "Čistič duplicit. Zaručí, že ve výsledku bude každá hodnota pouze jednou. Pokud máš v tabulce desetkrát 'Kámen', DISTINCT ti vrátí řádky se slovem 'Kámen' jen jednou.",
    ...
    "BETWEEN": "Hledá hodnoty v určitém rozsahu (včetně krajních hodnot). Například 'BETWEEN 10 AND 20' najde všechny hodnoty od desítky do dvacítky.",
    ...
    "IS NULL": "Ptá se, jestli je hodnota úplně prázdná. Pozor, prázdná hodnota (NULL) není to samé jako nula nebo prázdný text.",
    ...
    "ORDER BY": "Seřadí výsledné řádky podle vybraného sloupce. Můžeš řadit libovolně podle abecedy, čísel, datumů,...",
    ...
    "INNER JOIN": "Je to naprosto to samé jako obyčejný JOIN. Slovo INNER se tam může napsat navíc, aby bylo jasné, že hledáš pouze ty řádky, které mají záznam v obou spojovaných tabulkách.",
    "LEFT JOIN": "Funguje jako normální JOIN, ale s jedním rozdílem: vezme VŠECHNY řádky z první (levé) tabulky. Pokud k nim nenajde odpovídající data ve druhé tabulce, doplní tam prázdno (NULL).",
    "RIGHT JOIN": "Funguje jako normální JOIN, ale s jedním rozdílem: vezme VŠECHNY řádky z druhé (pravé) tabulky. Pokud k nim nenajde odpovídající data v první tabulce, doplní tam prázdno (NULL).",
    "CROSS JOIN": "Utvoří kartézský součin mezi dvěma tabulkami a přiřadí každý řádek přesně ke všem řádkům z druhé tabulky.",
    "GROUP BY": "Seskupuje řádky a vezme všechny záznamy, které mají v daném sloupci stejnou hodnotu, a zdrcne je do jedné skupiny. Je NUTNÉ při používání agregačních funkcí.",
    ...
    "INTERSECT": "Vytvoří průnik. Dá pouze výsledky dvou různých dotazů, které se vyskytují v obou z nich.",
    ...
    "UNION ALL": "Podobné jako UNION (spojí tabulky pod sebe), ale s jedním obrovským rozdílem, že nemaže duplikáty. Nechá tam úplně všechny řádky přesně tak, jak je dotazy našly.",
